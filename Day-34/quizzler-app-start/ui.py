...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.x_img = tkinter.PhotoImage(file="images/false.png")

        self.true_button = tkinter.Button(image=self.check_img, highlightthickness=0, command=self.true_pressed)
        self.false_button = tkinter.Button(image=self.x_img, highlightthickness=0, command=self.false_pressed)
